  ...
  return (
    <div className="rightBar">
      <div className="rightBar__container">
          ...
          <div className="rightBar__container__item__user">
            <div className="rightBar__container__item__user__userInfo">
              <img 
                ...
                alt="" 
              />
              <span className="rightBar__container__item__user__userInfo__username">Loren Nahshon</span>
            </div>
        ...
        <div className="rightBar__container__item">
          <span className="rightBar__container__item__title">Latest Activities</span>
          <div className="rightBar__container__item__user">
            <div className="rightBar__container__item__user__userInfo">
              <img 
                className="rightBar__container__item__user__userInfo__userimage"
              ...
              <p className="rightBar__container__item__user__userInfo__p">
                <span className="rightBar__container__item__user__userInfo__username">Loren Nahshon</span> changed their cover picture
              </p>
            </div>
            <span className="rightBar__container__item__user__timeActivity">1 min ago</span>
          </div>
          <div className="rightBar__container__item__user">
            <div className="rightBar__container__item__user__userInfo">
              <img 
        ...
        <div className="rightBar__container__item">
          <span className="rightBar__container__item__title">Online Friends</span>
          <div className="rightBar__container__item__user">
            <div className="rightBar__container__item__user__userInfo">
              <img 
                className="rightBar__container__item__user__userInfo__userimage"
